# Generated by Django 5.0.6 on 2024-09-22 19:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagenCat', models.ImageField(blank=True, null=True, upload_to='categoria')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='estadoProducto',
            fields=[
                ('idEstado', models.AutoField(primary_key=True, serialize=False, verbose_name='Id de Estado de Producto')),
                ('nombreEstado', models.CharField(max_length=50, verbose_name='Estado del Producto')),
            ],
        ),
        migrations.CreateModel(
            name='Logo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoProducto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Store.estadoproducto', verbose_name='Estado del Producto')),
            ],
            options={
